...
//        System.out.println(solution.findLadders("aaaaa", "uuuuu", wordList));
    ...
    class Solution {
        ...
        public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
            ...
            // 2、可达性检测
            if (reachable(words, beginWord, endWord)) {
        ...
        private boolean reachable(Set<String> words, String beginWord, String endWord) {
                ...
                for (String curWord : begins) {
                    ...
                    for (int i = 0; i < wordLen; i++) {
                        ...
                        for (char ch = 'a'; ch <= 'z'; ch++) {
                            curWordChars[i] = ch;
                            String word = String.valueOf(curWordChars);
